...
static int false_callback (const char *pw, const char *info)
{
    (void) pw;
...
static int true_callback (const char *pw, const char *info)
{
    (void) pw;
    (void) info;                        /* suppress warning */
    return 1;
...
static int print_callback (const char *pw, const char *info)
{
