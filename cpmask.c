...
static void load_img (const char *name)
{
    FILE *img;
    UI image_depth;
...
static void cp_set_pw (u8 * pw, u8 * pw_end)
{
    u8 *cursor;
    int i, j, x, y, len;
    int *table;
...
static int crack_cpmask (gen_func genfunc, callback_func cbfunc)
{
